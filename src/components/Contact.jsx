...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm('service_leo9e7d', 'template_fd8o423', form.current, 'IiBgqXZMUhPXtJCLj')
      .then((result) => {
  ...
  return (
    <div name='contact' className='w-full h-screen flex justify-center items-center p-4'>
      <form action="" className='flex flex-col max-w-[1000px] w-full' ref={form} onSubmit={handleSubmit}>
        ...
        <button className='bg-header-bg-fuchsia-900 text-[#f9fafc] px-4 py-3 my-8 flex items-center w-28 hover:bg-text-fuchsia-300 duration-200 hover:text-[#0F1729]'>Submit
          <span>
