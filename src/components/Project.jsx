    ...
    return (
        <div name='project' className='h-120 w-full text-[#0F1729]' >
            ...
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full text-justify'>
                ...
                <div className='mt-4 '>
                    <p className='text-text-small-slate-dark font-medium'>4. Car parts detection and Car Damage Identification </p>
                ...
                <div className='mt-4 '>
                    <p className='text-text-small-slate-dark font-medium'>6. Chatbot </p>
