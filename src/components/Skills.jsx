...
const Skills = () => {
    return (
        <div name='skills' className='w-full h-screen bg-theme-fuchsia-900 text-[#f9fafc]'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div class='max-w-[1000px] w-full gap-4 px-2 mt-4 pl-8 sm: pl-0 text-justify flex flex-col'>
                    <div class='w-full grid sm:grid-cols-2 flex flex-col gap-2 sm:gap-4 sm:flex-row sm:justify-center'>
                        ...
                        <p class='text-left sm:text-left sm:block'>Machine Learning, Computer Vision, Mobile App Development</p>
                    </div>
                    <div class='w-full grid sm:grid-cols-2 flex flex-col gap-2 sm:gap-4 sm:flex-row sm:justify-center'>
                        <p class='font-bold text-left text-lg sm:text-right'>Programming Languages:</p>
                        <p class='text-left sm:text-left sm:block'>C, Java, Python, JavaScript</p>
                    </div>
                    <div class='w-full grid sm:grid-cols-2 flex flex-col gap-2 sm:gap-4 sm:flex-row sm:justify-center'>
                        <p class='font-bold text-left text-lg sm:text-right'>Framework/API/Technologies:</p>
                        <p class='text-left sm:text-left sm:block'>Scikit-learn, TensorFlow, Keras, Pinecone, Langchain, OpenAI API, JSON, Google Map API, Facebook Graph API, React, React Native, GPT Prompting, Google Colab, DSCH, Microwind 2, MATLAB, Packet Tracer, CST, Solidworks</p>
                    </div>
                    <div class='w-full grid sm:grid-cols-2 flex flex-col gap-2 sm:gap-4 sm:flex-row sm:justify-center'>
                        <p class='font-bold text-left text-lg sm:text-right'>Database:</p>
                        <p class='text-left sm:text-left sm:block'>MySQL</p>
                    </div>
                    <div class='w-full grid sm:grid-cols-2 flex flex-col gap-2 sm:gap-4 sm:flex-row sm:justify-center'>
